...
OFILES = main.o font.o text.o myLib.o snake_title.o snake_dead.o side_bar.o danger.o end_theme.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h text.h snake_title.h snake_dead.h side_bar.h danger.h end_theme.h
# mylib.h
